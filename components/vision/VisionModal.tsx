...
export const VisionModal: React.FC<VisionModalProps> = ({ isOpen, onClose }) => {
    ...
    const phases = [
        {
            phase: 'Phase 1',
            title: 'sBTC Yield Nexus',
            period: '2025 Q1-Q4',
            status: 'In Development',
            chains: ['Bitcoin', 'Stacks'],
            features: ['sBTC yield strategies', 'Automated portfolio management', 'Risk assessment tools', 'Multi-protocol aggregation'],
            color: '#F7931A'
        },
        {
            phase: 'Phase 2',
            ...
            >
                ...
                <div className="text-center mb-6 pb-4" style={{ borderBottom: '2px solid rgba(247, 147, 26, 0.3)' }}>
                    ...
                    <p className="text-base mb-3" style={{ color: '#8C8C8C' }}>
                        sBTC Yield Nexus as the foundation for multi-chain expansion
                    </p>
                ...
                >
                    ...
                    <p className="text-sm leading-relaxed" style={{ color: '#8C8C8C' }}>
                        ...
                        <strong> sBTC Yield Nexus</strong> as our proven foundation, we're building architecture that scales
...
//         >
//             <div
//                 className="w-full max-w-6xl rounded-3xl p-12 relative max-h-[90vh] overflow-y-auto"
//                 style={{
//                     backgroundColor: '#FFFFFF',
//                     boxShadow: '0 25px 50px rgba(0, 0, 0, 0.3)',
//                     border: '1px solid rgba(255, 255, 255, 0.3)'
...
//                         Building the universal yield platform across all major blockchains
//                     </p>
//                     <div className="flex justify-center gap-3">
//                         <span
//                             className="px-3 py-1 rounded-full text-sm font-semibold"
...
//                     style={{ backgroundColor: 'rgba(0, 164, 120, 0.05)', border: '2px solid rgba(0, 164, 120, 0.2)' }}
//                 >
//                     <h3 className="text-xl font-bold mb-3" style={{ color: '#00A478' }}>
//                         🌟 Our Vision
//                     </h3>
//                     <p className="text-sm leading-relaxed" style={{ color: '#8C8C8C' }}>
//                         Yield Nexus will become the definitive platform for cross-chain yield generation, enabling users to access
//                         the best opportunities across all major blockchains from a single, unified interface. We're starting with
//                         Bitcoin to establish proven architecture and security standards, then expanding to create the most
//                         comprehensive multi-chain yield ecosystem in DeFi.
//                     </p>
//                 </div>

//                 {/* Expansion Phases */}
//                 <div className="mb-8">
//                     <h3 className="text-2xl font-bold mb-6" style={{ color: '#262626' }}>
//                         🗺️ Expansion Roadmap
//                     </h3>
...
//                             <div
//                                 key={index}
//                                 className="border-2 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1"
//                                 style={{
//                                     backgroundColor: `${phase.color}05`,
//                                     borderColor: `${phase.color}30`
//                                 }}
...
//                                         </div>
//                                         <div>
//                                             <h4 className="text-lg font-bold" style={{ color: '#262626' }}>
//                                                 {phase.phase}
//                                             </h4>
//                                             <p className="text-sm" style={{ color: '#8C8C8C' }}>
//                                                 {phase.period}
...
//                                     <div>
//                                         <h5 className="font-semibold mb-2" style={{ color: '#262626' }}>
//                                             Supported Blockchains:
//                                         </h5>
//                                         <div className="flex flex-wrap gap-2">
//                                             {phase.chains.map((chain, chainIndex) => (
...
//                                     <div>
//                                         <h4 className="font-bold mb-1" style={{ color: '#262626' }}>
//                                             {benefit.title}
//                                         </h4>
//                                         <p className="text-sm" style={{ color: '#8C8C8C' }}>
//                                             {benefit.description}
...
//                 {/* Footer CTA */}
//                 <div className="text-center mt-8 pt-6" style={{ borderTop: '1px solid rgba(0, 0, 0, 0.1)' }}>
//                     <p className="text-sm mb-4" style={{ color: '#8C8C8C' }}>
//                         Join us in building the future of cross-chain yield generation
//                     </p>
//                     <button
//                         className="px-6 py-3 rounded-full font-bold text-white transition-all duration-300 hover:-translate-y-1"
//                         style={{ backgroundColor: '#5546FF' }}
//                     >
//                         Follow Our Progress
//                     </button>
